...
@section('pageTitle', 'Modifier l\'utilisateur')
...
@section('content')
    ...
    <div class="">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-xl font-semibold tracking-tight theme-title">Modifier l'utilisateur</h1>
                <p class="mt-0 text-sm theme-muted-text">Mettez à jour les informations de l'utilisateur.</p>
